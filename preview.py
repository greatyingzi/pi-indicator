...
# ─── 5. Cat Animation (SVG-converted 5-frame pixel, pure yellow, no ground) ──

class CatAnimation:
    # SVG-converted 5-frame running cat — pure yellow body, no eye/ground
    FRAMES = [
        # Frame 1
        frozenset({(0,2),(0,3),(0,9),(0,10),(0,11),(0,12),(0,13),
                   (1,2),(1,3),(1,4),(1,9),(1,10),(1,11),(1,12),(1,13),(1,14),
                   (2,2),(2,3),(2,4),(2,5),(2,6),(2,7),(2,8),(2,9),(2,10),(2,11),(2,12),(2,13),
                   (3,2),(3,3),(3,4),(3,5),(3,6),(3,7),(3,8),(3,9),(3,10),(3,11),
                   (4,2),(4,3),(4,4),(4,5),(4,6),(4,7),(4,11),(4,12),(4,13),
                   (5,2),(5,3),(5,4),(5,5),(5,6),(5,9)}),
        # Frame 2
        frozenset({(0,9),(0,10),(0,11),(0,12),(0,13),
                   (1,2),(1,3),(1,9),(1,10),(1,11),(1,12),(1,13),(1,14),
                   (2,2),(2,3),(2,4),(2,5),(2,6),(2,7),(2,8),(2,9),(2,10),(2,11),(2,12),(2,13),
                   (3,3),(3,4),(3,5),(3,6),(3,7),(3,8),(3,9),(3,10),(3,11),
                   (4,2),(4,3),(4,4),(4,5),(4,6),(4,7),(4,8),(4,9),(4,13),(4,14),
                   (5,4),(5,5)}),
        # Frame 3
        frozenset({(0,2),(0,9),(0,10),(0,11),(0,12),(0,13),
                   (1,2),(1,3),(1,9),(1,10),(1,11),(1,12),(1,13),
                   (2,2),(2,3),(2,4),(2,8),(2,9),(2,10),(2,11),(2,12),(2,13),
                   (3,2),(3,3),(3,4),(3,5),(3,6),(3,7),(3,8),(3,9),(3,10),(3,11),(3,12),
                   (4,3),(4,4),(4,5),(4,6),(4,7),(4,8),(4,9),(4,10),(4,11),
                   (5,2),(5,3),(5,4),(5,5),(5,6),(5,11),(5,12),(5,13)}),
        # Frame 4
        frozenset({(0,2),(0,3),
                   (1,3),(1,9),(1,10),(1,11),(1,12),
